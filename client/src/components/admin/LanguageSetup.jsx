...
const LanguageSetup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`${LANGUAGE_API_END_POINT}/update/${params.id}`, formData, {
                headers: {
            ...
            <div className='max-w-xl mx-auto my-10'>
                <form onSubmit={submitHandler}>
                    <div className='flex items-center gap-5 p-8'>
                        <Button onClick={() => navigate("/admin/languages")} variant="outline" className="flex items-center gap-2 text-gray-500 font-semibold">
                            <ArrowLeft />
                            <span>Back</span>
                        </Button>
                        <h1 className='font-bold text-xl'>Language Setup</h1>
                    </div>
